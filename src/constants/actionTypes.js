...
export const STOCKROOM_ADD = 'STOCKROOM_ADD';
export const STOCKROOM_EDIT = 'STOCKROOM_EDIT';
export const STOCKROOM_REMOVE = 'STOCKROOM_REMOVE';
export const STOCKROOM_PAGE_LOADED = 'STOCKROOM_PAGE_LOADED';
export const STOCKROOM_PAGE_UNLOADED = 'STOCKROOM_PAGE_UNLOADED';