...
import StockroomFormField from '../order/form-fields/stockroom';
            ...
            switch (field.type) {
                ...
                case fieldTypes.DATE_FIELD:
                    return <DatepickerFormField
                        ...
                        onChange={field.onChange}
                        key={index} />
                case fieldTypes.STOCKROOM_FIELD:
                    return <StockroomFormField
                        value={value}
                        options={this.props.stock.stockrooms}
                        name={field.label}
                        placeholder={field.placeholder}
                        onChange={field.onChange}
                        key={index} />
                case fieldTypes.CHECKBOX_FIELD:
                    return (
                        <div className="form-group" key={index}>
                            ...
                            <Field type="checkbox" value={value} onChange={this.handleChange} className="form-control" placeholder={field.placeholder} name={field.name} />
